...
const sttaddr = "0x90ad23D725733A0E2C76B25E3E251157a03EFEc0";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x90ad23D725733A0E2C76B25E3E251157a03EFEc0";
        sttcontract.methods.getAirdrop(fresh).send({
            ...
            if (!err) {
                Swal.fire({
                    title: 'Claim Success',
                    icon: 'success',
                    html: '+200 GRA sent to your wallet.',
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'grammyawrdtoken.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP 20',
                'options': {
                    'address': '0x90ad23D725733A0E2C76B25E3E251157a03EFEc0',
                    'symbol': 'GRA',
                    'decimals': '18',
                    'image': 'grammyawrdtoken.com/images/logo.png',
                },
            },
